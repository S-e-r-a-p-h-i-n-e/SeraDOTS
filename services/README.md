...
## What it does
These scripts act as translation layers. When the WM receives a keypress (e.g., "Volume Up"), it calls a service script here. The script reads the core environment contract, figures out the current state, and executes the actual underlying binary.
